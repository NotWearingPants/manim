...
class VectorScene(Scene):
    ...
    def add_vector(
        self,
        vector: Arrow | np.ndarray | list | tuple,
        color: str = YELLOW,
        animate: bool = True,
        **kwargs,
    ):
    ...
    def show_ghost_movement(self, vector: Arrow | np.ndarray | list | tuple):
        """
...
class LinearTransformationScene(VectorScene):
    ...
    def add_vector(
        self, vector: Arrow | np.ndarray | list | tuple, color: str = YELLOW, **kwargs
    ):
        """
    ...
    def add_transformable_label(
        ...
        vector: Vector,
        label: MathTex | str,
        transformation_name: MathTex | str = "L",
        new_label: MathTex | str | None = None,
        **kwargs,
    ):
        """
    ...
    def get_piece_movement(self, pieces: np.ndarray | list | tuple):
        """
